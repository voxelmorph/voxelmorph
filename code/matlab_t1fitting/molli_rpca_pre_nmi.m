...
round=1
path = "results/MOLLI_pre/Group/rank_2_3_4/nmi/smooth/image_loss_weight1/cycle_loss_weight0.01/weight0.001/bspline/cps4_svfsteps7_svfscale1/e100/test_MOLLI_pre";
tmp = sprintf('../%s/round%d/moved_mat/*.mat', path, round)
MOLLI_REGISTER_FILES = dir(sprintf('../%s/round%d/moved_mat/*.mat', path, round))
MOLLI_NATIVE_FOLDER = '../data/MOLLI_original';
label = sprintf('../%s/round%d/T1_SDerr', path, round)
mkdir(label)
